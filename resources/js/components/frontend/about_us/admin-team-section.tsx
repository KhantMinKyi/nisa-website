    ...
    return (
        <div className="w-full ">
            ...
            <div className="relative z-10 mt-20  ">
                <motion.div
                    className="container mx-auto grid grid-cols-1 gap-6 sm:grid-cols-1 lg:grid-cols-2"
                ...
                >
                    {cards.map((item) => (
                        <motion.div
                            ...
                            className="flex cursor-pointer flex-col items-center justify-center  py-12 px-6 text-center   rounded-sm "
                        >
