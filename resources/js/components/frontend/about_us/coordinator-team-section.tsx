...
export default function CoordinatorTeamSection() {
    ...
    const cards = [
        { id: 1, title: "BFI Education Sevices", img: <img src="/img/admin/3.webp" className="h-80" />, webUrl: 'https://www.bfi.edu.mm/' },
        { id: 2, title: "SKT International School ( City Campus )", img: <img src="/img/admin/4.webp" className="h-80" />, webUrl: 'https://skt.edu.mm/skt-city-campus' },
        { id: 3, title: "SKT International School ( Riverside Campus )", img: <img src="/img/admin/5.webp" className="h-80" />, webUrl: 'https://skt.edu.mm/skt-riverside-campus' },
    ];
