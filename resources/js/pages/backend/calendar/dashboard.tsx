...
export default function CalendarIndex({ calendars }: Props) {
    ...
    const handleDelete = (id: number) => {
        if (confirm('Are you sure? This cannot be undone.')) {
            ...
            router.delete('/admin/calendars/' + id);
        }
    };
            ...
            <div className="py-12">
                <div className="mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        >
                            <HiPlus className="mr-2 text-base" /> Add Calendar
                        </Link>
                    </div>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-right text-sm font-medium whitespace-nowrap">
                                            ...
                                            >
                                                ...
                                                >
                                                    <Menu.Items
                                                        className={`ring-opacity-5 absolute right-0 z-50 w-36 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg focus:outline-none dark:bg-neutral-900 ${index >=
                                                            calendars.data
                                                                .length -
                                                            2
                                                        ...
                                                        <div className="px-1 py-1">
                                                            <Menu.Item>
                                                                {({
                                                                    ...
                                                                    <Link
                                                                        href={`/admin/calendars/${item.id}/edit`}
