...
export default function FacilityCreate({ categories }: { categories: Category[] }) {
    const { data, setData, post, processing, errors } = useForm({
        alt: '',
        facility_category_id: categories?.[0]?.id ?? '',
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto w-5xl px-4 py-10">
                ...
                >
                    <HiArrowLeft className="mr-1" /> Back to Facility
                </Link>
                ...
                <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm dark:border-brand-core dark:bg-neutral-800">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex justify-end pt-4">
                            ...
                            >
                                {processing ? 'Uploading...' : 'Save Facility'}
                            </button>
                        </div>
                    </form>
                </div>
